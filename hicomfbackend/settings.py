"""
Django settings for hicomfbackend project.
...
SECRET_KEY = '$wat)utj+58h078_a$0$h!1*%tkc9ub1rdgobtf^^fqm00sqq('
...
ROOT_URLCONF = 'hicomfbackend.urls'
...
WSGI_APPLICATION = 'hicomfbackend.wsgi.application'
